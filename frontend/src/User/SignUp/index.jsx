...
class SignUp extends Component {
  ...
  handleSubmit(event) {
    ...
    const { uname, password, passwordConfirm, name, email } = this.state;

    if (!uname.length || !password.length || !passwordConfirm.length || !name.length || !email.length) return;
  ...
  render() {
    const { redirectToSignIn, uname, password, passwordConfirm, name, email } = this.state;
    if (redirectToSignIn) return <Redirect to="/user/signin" />;
    return (
            ...
            <Card>
              <Card.Body>
                ...
                <Form onSubmit={this.handleSubmit}>
                  ...
                  <InputTextGroup label="New Password" name="password" type="password" value={password} icon={<LockFill />} onChange={this.handleChange} />
                  <InputTextGroup label="Confirm New Password" name="passwordConfirm" type="password" value={passwordConfirm} icon={<LockFill />} onChange={this.handleChange} />
